...
// ================================
(function () {
    const targetDate = new Date('December 20, 2025 20:00:00').getTime();
...
(function () {
    ...
    // ——— Pause background music when proposal video plays ———
    (function () {
        const vid = document.getElementById('proposalVideo');
        const bg = document.getElementById('weddingSong');
        if (!vid || !bg) return;
        ...
        // Optional: auto-resume music when the video fully ends
